...
from Dusky.utils.commands import *
from Dusky import *
from Dusky.mongo import chatb,kukib,lunab
from Dusky.plugins.antlangs import get_arg
...
async def szcbot(_, message: Message):
    ...
    if chat:
       ...
       affiliateplus = requests.get(f"https://api.affiliateplus.xyz/api/chatbot?message={text}&botname=DuskyRobot%20Bot&ownername=Dusky%20Joe%20Contact%20him%20@OFFICIAL_DUSKY&user=1")
...
**Available chatbots**
• Dusky - Advanced, inteligent and cute chatbot which will keep you happy all time.. 


**Language Support**
Dusky AI chatbot support almost all languages in world .
