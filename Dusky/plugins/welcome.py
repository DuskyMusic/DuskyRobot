...
from Dusky import *
from Dusky.mongo.gban import GBan
from Dusky.mongo.welcomedb import Greetings
from Dusky.utils.custom_filters import admin_filter, command
...
from Dusky.mongo.feddb import (get_fed_from_chat,
...
my news channel @DuskysUpdates.

**New to Me, Touch the below button and start me in PM**
                    """,
                    reply_markup=InlineKeyboardMarkup(
            [
                InlineKeyboardButton("quick start guide", url="http://t.me/DuskyRobot?start=help"),
            ]))
        ...
        if member.id == OWNER_ID:
               ...
               return
        if user_id == 5696423555:#for @OFFICIAL_DUSKY 
               await app.send_message(
                message.chat.id,
