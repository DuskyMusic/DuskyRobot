...
from Dusky.mongo.notesdb import Notes, NotesSettings
from Dusky.utils.cmd_senders import send_cmd
from Dusky.utils.custom_filters import admin_filter, command, owner_filter
from Dusky.utils.kbhelpers import rkb as ikb
from Dusky.utils.msg_types import Types, get_note_type
from Dusky.utils.string import (
    build_keyboard,
    escape_mentions_using_curly_brackets,
    parse_button,
)
from Dusky.mongo.connectiondb import active_connection
            ...
            reply_markup=ikb(
                [
                    [
                        (
                            "Click Me!",
                            f"https://t.me/DuskyRobot?start=note_{m.chat.id}_{note_hash}",
                            "url",
                        ),
                    ],
                ],
        ...
        pm_kb = ikb(
            [
                [
                    (
                        "All Notes",
                        f"https://t.me/DuskyRobot?start=notes_{grp_id}",
                        "url",
                    ),
                ],
            ],
