...
from Dusky.menu import *
from Dusky import *
from Dusky.plugins import ALL_MODULES
from Dusky.utils import paginate_modules
from lang import get_command
from Dusky.utils.lang import *
from Dusky.utils.commands import *
from Dusky.mongo.rulesdb import *
from Dusky.utils.start import *
from Dusky.mongo.usersdb import *
from Dusky.mongo.restart import *
...
async def start_bot():
    ...
    for module in ALL_MODULES:
        imported_module = importlib.import_module("Dusky.plugins." + module)
        if (
...
home_keyboard_pm = InlineKeyboardMarkup(
    [
        ...
        [
            InlineKeyboardButton(
                text="📓 Developer",
                url=f"https://t.me/OFFICIAL_DUSKY",
            )
        ],
        [
            InlineKeyboardButton(
