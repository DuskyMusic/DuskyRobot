...
Dusky Robot supports a large number of formatting 
...
- <code>[hyperlink](google.com)</code>: This will create a <a href='http://www.DuskyJoe.ml/'>hyperlink</a> text.
...
Alternatively, check out <a href='http://www.DuskyJoe.ml/Dusky.html'>This Web site</a> to generate the button syntax for yoctx.

- [note button](buttonurl://#notename): This syntax will allow you to 
create a button which links to a note. When clicked, 
the user will be redirected to Dusky Robot's PM to see the note.
"""
